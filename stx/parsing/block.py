...
def parse(reader: Reader, stop_marks: Stack) -> Block:
    components = []
    ...
    while True:
        ...
        component = (separator.parse(reader, stop_marks) or
                     ...
                     row.parse(reader, stop_marks) or
